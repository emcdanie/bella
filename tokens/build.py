...
css_lines += [
    ...
    "  --ring-focus-color:   var(--color-semantic-focus-ring);  /* ochre-deep light, ochre dark: the one coloured stroke; focus only, never at rest (brand refresh, 2026-09-22) */",
...
theme_values = {
    ...
    "bg":          tok("color.light.bg"),
    "panel":       tok("color.light.panel"),
    "line":        tok("color.light.line"),
    "control":     tok("color.light.control"),
    "ink":         tok("color.light.ink"),
    "muted":       tok("color.light.muted"),
    "darkBg":      tok("color.dark.bg"),
    "darkSurface": tok("color.dark.surface"),
    "darkLine":    tok("color.dark.line"),
    "darkControl": tok("color.dark.control"),
    "darkInk":     tok("color.dark.ink"),
    "darkMuted":   tok("color.dark.muted"),
    "ochre":       tok("color.brand.ochre"),
    "ochreDeep":   tok("color.brand.ochre-deep"),
...
# Favicon: no longer generated here. The brand refresh (2026-09-22) favicon
# is pattern E on cream, built by scripts/build-favicons.mjs from a fixed
# seed so it never changes between builds.
...
def primitive_colors():
    blocks = []
    groups = [("brand", "Brand"), ("light", "Light"), ("dark", "Dark"), ("chip", "Chips"), ("neutral", "Light neutrals"), ("navy", "Navy scale"), ("night", "Warm dark scale"), ("supporting", "Status (carried)"), ("alpha", "Alpha variants")]
